import { AnimationCurve, Animator, Interpolator } from './animator';
import { Attribute, AttributeDefinition } from './attribute';
import { Advanceable } from './ticker';
import { TimeProvider } from './utils';
interface MarkBase {
}
export type MarkListener<T extends AttributeSetBase> = (mark: Mark<T>, attrName: keyof T, animated: boolean) => void;
export type AttributeSetBase = {
    [key: string]: Attribute<any, any, any>;
};
export type SimpleAnimationOptions = {
    duration?: number;
    curve?: AnimationCurve;
    delay?: number;
    overrideIfIdentical?: boolean;
};
...
export type MarkUpdateListener<AttributeSet extends AttributeSetBase, K extends keyof AttributeSet, AttributeType extends AttributeSet[K]> = (mark: Mark<AttributeSet>, finalValue: AttributeType['value']) => Promise<void> | void;
export type MarkEventListener<AttributeSet extends AttributeSetBase> = (mark: Mark<AttributeSet>, details: any, eventName: string) => Promise<void> | void;
export type MarkGraphListener<T extends AttributeSetBase> = (mark: Mark<T>, edge: string, oldAdjacency: Mark<T>[], newAdjacency: Mark<T>[]) => void;
export type MarkHitTest<T extends AttributeSetBase> = (mark: Mark<T>, location: number[]) => boolean;
/**
...
export type ImplicitAttributeSet<AttributeSet extends AttributeSetBase> = {
    [K in keyof AttributeSet]?: ReturnType<AttributeSet[K]['get']> | AttributeSet[K]['valueFn'] | AttributeDefinition<ReturnType<AttributeSet[K]['get']>, ReturnType<AttributeSet[K]['getUntransformed']>> | AttributeSet[K];
};
/**
 * An object representing something visually depicted, that is described by
 * one or more `Attribute`s.
 */
export declare class Mark<AttributeSet extends AttributeSetBase = MarkAttributes> implements MarkBase, Advanceable {
    private _timeProvider;
    id: any;
    attributes: AttributeSet;
    private _attrNames;
    private _listeners;
    private _graphListeners;
    ...
    private _hitTest;
    private _adjacency;
    private _reverseAdjacency;
    /** The object that this Mark represents. */
    represented: any | undefined;
    ...
    onUpdate<K extends keyof AttributeSet, AttributeType extends AttributeSet[K]>(attrName: K, action: MarkUpdateListener<AttributeSet, K, AttributeType>): Mark<AttributeSet>;
    onEvent(eventName: string, action: MarkEventListener<AttributeSet>): Mark<AttributeSet>;
    /**
    ...
    addGraphListener(listener: MarkGraphListener<AttributeSet>): Mark<AttributeSet>;
    removeGraphListener(listener: MarkGraphListener<AttributeSet>): Mark<AttributeSet>;
    private _attributesChanged;
    /**
     ...
     */
    setAttr<K extends keyof AttributeSet, AttributeType extends AttributeSet[K]>(attrName: K, newValue?: AttributeType['value'] | AttributeType['valueFn'] | undefined): Mark<AttributeSet>;
    /**
     ...
     * * @see Attribute.get
     */
    attr<K extends keyof AttributeSet, AttributeType extends AttributeSet[K], T extends Boolean>(attrName: K, transformed?: T): T extends true ? ReturnType<AttributeType['get']> : ReturnType<AttributeType['getUntransformed']>;
    /**
    ...
    get(transformed?: boolean | {
        [key in keyof AttributeSet]?: boolean;
    }): {
     ...
     * @see Attribute.data
     */
    data<K extends keyof AttributeSet, AttributeType extends AttributeSet[K]>(attrName: K): AttributeType['value'];
    /**
     ...
     */
    updateTransform<K extends keyof AttributeSet>(attrName: K): Mark<AttributeSet>;
    animateTo<K extends keyof AttributeSet, AttributeType extends AttributeSet[K]>(attrName: K, finalValue: AttributeType['value'] | ((computeArg: AttributeType['computeArg']) => AttributeType['value']), options?: SimpleAnimationOptions): Mark<AttributeSet>;
    animate<K extends keyof AttributeSet, AttributeType extends AttributeSet[K]>(attrName: K, options?: AnimationOptions<AttributeType['value']> | Animator<AttributeType['value']>): Mark<AttributeSet>;
    /**
     ...
     */
    copy(id: any, newValues?: ImplicitAttributeSet<AttributeSet>): Mark<AttributeSet>;
    /**
...
type AttributeConstructorShorthand<AttributeSet extends AttributeSetBase, K extends keyof AttributeSet> = ((val: AttributeSet[K]['value']) => AttributeSet[K]) | ((val: AttributeSet[K]['valueFn']) => AttributeSet[K]);
export type AttributeSetConstructor<AttributeSet extends AttributeSetBase> = {
    [K in keyof AttributeSet]: AttributeSet[K] | AttributeConstructorShorthand<AttributeSet, K>;
};
/**
 ...
 */
export declare function defineMark<AttributeSet extends AttributeSetBase = MarkAttributes>(constructorFn: ((id: any, values?: ImplicitAttributeSet<AttributeSet>) => Mark<AttributeSet> | AttributeSet) | AttributeSetConstructor<AttributeSet>): {
    create: (id: any, values?: ImplicitAttributeSet<AttributeSet>) => Mark<AttributeSet> | Mark<{
        [x: string]: any;
    }>;
};
export {};
