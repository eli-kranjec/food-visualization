...
// node_modules/counterpoint-vis/dist/counterpoint-vis.es.js
var gi = Object.defineProperty;
var pi = (i, t, e) => t in i ? gi(i, t, { enumerable: true, configurable: true, writable: true, value: e }) : i[t] = e;
...
var Mi = ((i) => (i[i.DEFAULT = 0] = "DEFAULT", i[i.ALWAYS = 1] = "ALWAYS", i[i.WHEN_UPDATED = 2] = "WHEN_UPDATED", i))(Mi || {});
var M = class _M {
  /**
   *
   ...
   */
  constructor(t) {
    if (this.valueFn = void 0, this.transform = void 0, this.cacheTransform = false, this._cachedValue = null, this.computeArg = void 0, this.recompute = 0, this.needsUpdate = false, this.animation = null, this.label = null, this._computedValue = null, this._lastTickValue = void 0, this._animatedValue = null, this._hasComputed = false, this._timeProvider = null, this.currentTime = 0, this._changedLastTick = false, this._preload = false, this._listeners = [], this._animationCompleteCallbacks = [], this._animationCompleteTimeout = null, t == null || t == null || !(t.hasOwnProperty("value") || t.hasOwnProperty("valueFn")))
      ...
      ), this.transform = e.transform ?? null, this.cacheTransform = e.cacheTransform ?? false, this._cachedValue = null, this.computeArg = e.computeArg ?? null, this.recompute = e.recompute ?? 0, this._preload = e.preload ?? false;
    }
  }
  /**
   ...
   */
  registerPreloadable() {
    return this._preload = true, this;
  }
  /**
  ...
  copy(t = {}) {
    let e = { ...this, ...t };
    return t.value !== void 0 && (e.valueFn = void 0), t.valueFn !== void 0 && (e.value = void 0), new _M(e);
  }
  addListener(t) {
  ...
  advance(t = void 0) {
    ...
    ), this._cleanUpAnimation(true)), this._lastTickValue = void 0, this._lastTickValue = this.getUntransformed(), this.animation != null || this.needsUpdate ? (this.needsUpdate = false, this._changedLastTick = true, true) : (this._changedLastTick = false, false);
  }
  _computeAnimation(t = true) {
    if (!this.animation)
      return;
    ...
    this._animationFinished() && t ? (this.valueFn ? (this.recompute !== 2 || !this._hasComputed) && (this.compute(), this._hasComputed = true) : this.value = s, this._cleanUpAnimation(false), this._animatedValue = null) : this._animatedValue = s;
  }
  _animationFinished() {
    return this.animation ? this.animation.animator.duration + 20 <= this.currentTime - this.animation.start : true;
  }
  _performTransform(t) {
    let e;
    if (this.transform) {
  ...
  _cleanUpAnimation(t = false) {
    this._preload && this.animation && !t && (this.valueFn ? ((this.recompute !== 2 || !this._hasComputed) && (this.compute(), this._hasComputed = true), this._lastTickValue = this.animation.animator.finalValue) : (this.value = this.animation.animator.finalValue, this._lastTickValue = this.value)), this.animation = null, this._animatedValue = null, this._animationCompleteCallbacks.forEach((e) => {
  ...
  getUntransformed() {
    ...
    let t;
    return this._animatedValue != null ? t = this._animatedValue : this.valueFn ? ((this.recompute !== 2 || !this._hasComputed) && (this.compute(), this._hasComputed = true), t = this._computedValue) : t = this.value, this._lastTickValue = t, t;
  }
  /**
  ...
  getPreloadUntransformed(t = null) {
    ...
    let e;
    this.valueFn ? ((this.recompute !== 2 || !this._hasComputed) && (this.compute(), this._hasComputed = true), e = this._computedValue) : e = this.value;
   ...
   */
  set(t) {
    typeof t == "function" ? (this.value != null && (this._computedValue = this.getUntransformed()), this.valueFn = t, this.value = void 0, this._hasComputed = false, this._animatedValue = null) : (this.value = t, this.valueFn = null, this._animatedValue = null), this.needsUpdate = true, this._lastTickValue = void 0, this.animation && this._cleanUpAnimation(true), this._listeners.forEach((e) => e(this, false));
  }
  /**
   ...
   */
  last() {
    return this.animation && this._preload && this._computeAnimation(false), this._lastTickValue !== void 0 ? this._lastTickValue : this._animatedValue != null ? this._animatedValue : this.value !== void 0 ? this.value : this._computedValue;
  }
  /**
  ...
  animate(t) {
    if (this._timeProvider && (this.currentTime = this._timeProvider()), this.animation) {
      ...
      this.valueFn ? this._computedValue = e : this.value = e, this._lastTickValue = this._animatedValue, this._cleanUpAnimation(true);
    }
    return this.animation = {
      animator: t,
      initial: this.last(),
      start: this.currentTime
    }, this._computeAnimation(), this._listeners.forEach((e) => e(this, true)), this;
  }
  /**
   ...
   */
  freeze() {
    return this.animation && this._cleanUpAnimation(true), this.value = this.last(), this.valueFn = void 0, this;
  }
  /**
...
function Be(i) {
  ...
  if (r) {
    ...
    return r[2].replace(/\/?\s*([-\w.]+(?:%|deg)?)/g, (s, n) => {
      /%$/.test(n) ? (n = new Number(n.slice(0, -1) / 100), n.type = "<percentage>") : /deg$/.test(n) ? (n = new Number(+n.slice(0, -3)), n.type = "<angle>", n.unit = "deg") : e.test(n) && (n = new Number(n), n.type = "<number>"), s.startsWith("/") && (n = n instanceof Number ? n : new Number(n), n.alpha = true), a.push(n);
    }), {
...
var C = class C2 {
  constructor(t) {
    var a, s, n;
    this.id = t.id, this.name = t.name, this.base = t.base ? C2.get(t.base) : null, this.aliases = t.aliases, this.base && (this.fromBase = t.fromBase, this.toBase = t.toBase);
  ...
  equals(t) {
    return t ? this === t || this.id === t.id : false;
  }
  to(t, e) {
    if (arguments.length === 1 && ([t, e] = [t.space, t.coords]), t = C2.get(t), this.equals(t))
      return e;
  ...
  from(t, e) {
    return arguments.length === 1 && ([t, e] = [t.space, t.coords]), t = C2.get(t), t.to(this, e);
  }
  toString() {
  ...
  static get all() {
    return [...new Set(Object.values(C2.registry))];
  }
  static register(t, e) {
   ...
   */
  static get(t, ...e) {
    if (!t || t instanceof C2)
      return t;
    if ($(t) === "string") {
      let a = C2.registry[t.toLowerCase()];
      if (!a)
  ...
  static resolveCoord(t, e) {
    var h;
    let r = $(t), a, s;
    if (r === "string" ? t.includes(".") ? [a, s] = t.split(".") : [a, s] = [, t] : Array.isArray(t) ? [a, s] = t : (a = t.space, s = t.coordId), a = C2.get(a), a || (a = e), !a)
...
function wt(i, {
  ...
  let o = i.coords;
  if (o = o.map((l) => l || 0), r && !et(i) && (o = I(rt(i), r === true ? void 0 : r).coords), e.type === "custom")
...
var ut = 1.09929682680944;
var se = 0.018053968510807;
var Xe = new x({
  id: "rec2020",
  name: "REC.2020",
  base: Tt,
...
var oe = Array(3).fill("<percentage> | <number>[0, 255]");
var he = Array(3).fill("<number>[0, 255]");
var at = new x({
  id: "srgb",
  name: "sRGB",
  base: Ie,
...
var gt = 2 ** -16;
var Ft = -0.35828683;
var pt = (Math.log2(65504) + 9.72) / 17.52;
var Wr = new x({
  id: "acescc",
  name: "ACEScc",
...
var _ = class __ {
  ...
  clone() {
    return new __(this.space, this.coords, this.alpha);
  }
  toJSON() {
    return {
  ...
  display(...t) {
    let e = Bi(this, ...t);
    return e.color = new __(e.color), e;
  }
  /**
   ...
   */
  static get(t, ...e) {
    return t instanceof __ ? t : new __(t, ...e);
  }
  static defineFunction(t, e, r = e) {
    let { instance: a = true, returns: s } = r, n = function(...o) {
      let h = e(...o);
      if (s === "color")
        h = __.get(h);
        ...
        s === "array<color>" && (h = h.map((l) => __.get(l)));
      return h;
    };
    t in __ || (__[t] = n), a && (__.prototype[t] = function(...o) {
      return n(this, ...o);
    });
  }
  static defineFunctions(t) {
    for (let e in t)
      __.defineFunction(e, t[e], t[e]);
  }
  static extend(t) {
    if (t.register)
      t.register(__);
  ...
  Object.defineProperty(_.prototype, e, {
    ...
    get() {
      ...
      return typeof Proxy > "u" ? r : new Proxy(r, {
        has: (a, s) => {
          try {
            return f.resolveCoord([t, s]), true;
          } catch {
          }
        ...
        set: (a, s, n, o) => {
          if (s && typeof s != "symbol" && !(s in a) || s >= 0) {
            ...
            if (h >= 0)
              return a[h] = n, this.setAll(i, a), true;
          }
...
var ta = ((i) => (i.Waiting = "waiting", i.Entering = "entering", i.Visible = "visible", i.Exiting = "exiting", i.Completed = "completed", i))(ta || {});
var ea = ((i) => (i.Show = "show", i.Hide = "hide", i))(ea || {});
var ia = class {
  constructor(t = {}) {
    this.markStates = /* @__PURE__ */ new Map(), this.marksByID = /* @__PURE__ */ new Map(), this.queuedAnimations = /* @__PURE__ */ new Map(), this._flushTimer = null, this.animatingMarks = /* @__PURE__ */ new Set(), this._updated = false, this.defer = false, this._showedPromiseWarning = false, this.saveExitedMarks = false, this._callbacks = {
  ...
  advance(t) {
    return this._updated ? (this._updated = false, true) : false;
  }
  /**
  ...
  _perform(t, e) {
    if (t) {
      if (e == "show") {
        ...
        r && r instanceof Promise ? (this.animatingMarks.add(t), r.then(
          () => {
            this.markStates.has(t) && this.markStates.get(t) == "entering" && (this.markStates.set(
              ...
              "visible"
              /* Visible */
            ), this.animatingMarks.delete(t), this._updated = true);
          },
          () => {
        ...
        ), this._showedPromiseWarning = true), this.markStates.set(
          t,
          "visible"
          /* Visible */
        ));
        ...
        a && a instanceof Promise ? (this.animatingMarks.add(t), a.then(
          () => {
            this.markStates.has(t) && this.markStates.get(t) == "exiting" && (this.saveExitedMarks ? this.markStates.set(
              ...
              "completed"
              /* Completed */
            ) : (this.marksByID.delete(t.id), this.markStates.delete(t), this.animatingMarks.delete(t)), this._updated = true);
          },
          () => {
            this.animatingMarks.delete(t);
          }
        ...
        ), this._showedPromiseWarning = true), this.saveExitedMarks ? this.markStates.set(
          t,
          "completed"
          /* Completed */
  ...
  _enqueue(t, e) {
    ...
    return this.defer ? (this.queuedAnimations.set(t, e), this._flushTimer || (this._flushTimer = window.setTimeout(() => this._flush(), 0))) : this._perform(t, e), true;
  }
  /**
...
var ra = class {
  ...
  constructor(t = [], e = {
    ...
    this.timeProvider = null, this.marks = [], this.factory = null, this.lazyUpdates = true, this.useStaging = true, this.stage = null, this.markArrayDirty = false, this.animatingMarks = /* @__PURE__ */ new Set(), this.updatedMarks = /* @__PURE__ */ new Set(), this.preloadableProperties = /* @__PURE__ */ new Set(), this._forceUpdate = false, this._markListChanged = false, this._changedLastTick = false, this._updateListeners = {}, this._eventListeners = {}, this.timeProvider = Re(), this.lazyUpdates = true, this._defaultDuration = 1e3, this._defaultCurve = Z, this.configure(e), typeof t == "function" ? this.factory = t : this.marks = t, this.marksByID = /* @__PURE__ */ new Map(), this.markSet = /* @__PURE__ */ new Set(), this.marks.forEach((r, a) => {
  ...
  _setupMark(t) {
    this._configureMark(t), t.addListener((e, r, a) => {
      this.updatedMarks.add(e), !this.preloadableProperties.has(r) && a && this.animatingMarks.add(e), this._changedLastTick = true;
   ...
   */
  forceUpdate() {
    return this._forceUpdate = true, this;
  }
  /**
   ...
   */
  getMarks() {
    return this.markArrayDirty && (this.marks = Array.from(this.markSet)), this.markArrayDirty = false, this.marks;
  }
  /**
  ...
  advance(t) {
    ...
    if (this.updatedMarks = /* @__PURE__ */ new Set(), !(((a = this.stage) == null ? void 0 : a.advance(t)) ?? false) && e.length == 0 && !this._forceUpdate && !this._markListChanged)
      return this._changedLastTick = false, false;
    let r = /* @__PURE__ */ new Set();
    for (let s of e)
      r.has(s) || (s.advance() || this.animatingMarks.delete(s), r.add(s));
    return this._forceUpdate = false, this._markListChanged = false, this._changedLastTick = true, true;
  }
  /**
   ...
   */
  addMark(t) {
    return this.markSet.has(t) ? this : (this.marks.push(t), this.marksByID.set(t.id, t), this.markSet.add(t), this._setupMark(t), this._markListChanged = true, this.stage && this.stage.show(t), this);
  }
  /**
   ...
   */
  deleteMark(t) {
    return this.markSet.has(t) ? (this.marksByID.delete(t.id), this.markSet.delete(t), this.markArrayDirty = true, this._markListChanged = true, this.stage && this.stage.hide(t), this) : this;
  }
  /**
...
var G = class _G {
  ...
  _attributesChanged(t, e) {
    this._changedLastTick = true, this._changedAttributes[t] = true, this._listeners.forEach((r) => r(this, t, e)), this._updateListeners[t] && this._updateListeners[t](this, this.attributes[t].future());
  }
  /**
   ...
   */
  hitTest(t) {
    return this._hitTest ? this._hitTest(this, t) : true;
  }
  setTimeProvider(t) {
  ...
  advance(t = void 0) {
    ...
    for (let r of this._attrNames) {
      if (!this._changedAttributes[r])
        continue;
      this.attributes[r].advance(t) ? e = true : this._changedAttributes[r] = false;
    }
    return e ? (this.framesWithUpdate += 1, this.framesWithUpdate > aa && console.warn("Marks are being updated excessively!"), this._changedLastTick = true, true) : (this.framesWithUpdate = 0, this._changedLastTick = false, false);
  }
  /**
  ...
  setAttr(t, e = void 0) {
    ...
    let a = r.last();
    return e === void 0 ? r.compute() : r.set(e), K(a, r.data()) || this._listeners.forEach((s) => s(this, t, false)), this;
  }
  /**
  ...
  animateTo(t, e, r = {}) {
    ...
    ), (r.overrideIfIdentical ?? true) || !K(e, this.attributes[t].data())) {
...
var da = class {
  constructor(t) {
    this._callbacks = [], this._lastTick = void 0, this.stopped = true, typeof t.advance == "function" ? this.toAdvance = [t] : this.toAdvance = t, this.start();
  }
  onChange(t) {
    return this._callbacks.push(t), this;
  }
  start() {
    return this._lastTick = window.performance.now(), this.stopped = false, this._callbacks.forEach((t) => t()), requestAnimationFrame((t) => this.tick(t)), this;
  }
  stop() {
    return this._lastTick = void 0, this.stopped = true, this;
  }
  tick(t) {
...
var ma = class {
  constructor(t = {}) {
    this.animationDuration = 1e3, this.squareAspect = true, this._xDomain = [
      new M(0),
      new M(1)
    ], this._yDomain = [
      new M(0),
      ...
      new M(0),
      new M(1)
    ], this._xScaleFactor = new M(1), this._yScaleFactor = new M(1), this._translateX = new M(0), this._translateY = new M(0), this._calculatingTransform = false, this.timeProvider = Re(), this.controller = null, this._updatedNoAdvance = false, this.listeners = [], this.xScale = Object.assign(
  ...
  advance(t = void 0) {
    ...
    ].some((r) => r) ? (this._updatedNoAdvance = false, this.listeners.forEach((r) => r(this)), true) : (this._updatedNoAdvance || (this.listeners.forEach((r) => r(this)), this._updatedNoAdvance = true), false);
  }
  ...
  _calculateControllerTransform() {
    ...
    return this._calculatingTransform = false, t;
  }
  /**
...
var li = class {
   ...
   */
  constructor(t, e = {}) {
    this.lastCompute = void 0, this.marks = t, this.centerMark = e.centerMark !== void 0 ? e.centerMark : void 0, this.centerMark && !this.marks.includes(this.centerMark) && (this.marks = [...this.marks, this.centerMark]), this.xAttr = e.xAttr !== void 0 ? e.xAttr : "x", this.yAttr = e.yAttr !== void 0 ? e.yAttr : "y", this.padding = e.padding !== void 0 ? e.padding : 20, this.transformCoordinates = e.transformCoordinates ?? false, this.inverseTransformCoordinates = e.inverseTransformCoordinates ?? false;
  }
  transform(t) {
...
var _a = class {
  constructor(t = {}) {
    this.markCollections = [], this._positionMap = null, this._binSizes = null, this._extents = null, this._numBins = null, this._numMarks = null, this._avgMarksPerBin = null, this._coordinateAttributes = t.coordinateAttributes ?? ["x", "y"], this._transformCoordinates = t.transformCoordinates ?? true, this._avgMarksPerBin = t.marksPerBin ?? null, this._maximumHitTestDistance = t.maximumHitTestDistance ?? 1e12;
  }
  /**
...
var sa = ((i) => (i.none = "no-preference", i.more = "more", i.less = "less", i))(sa || {});
var na = ((i) => (i.light = "light", i.dark = "dark", i))(na || {});
var oa = class {
  constructor() {
  ...
  _handleMotion(t) {
    this._prefersReducedMotion = t.matches, this._hasChanged = true;
  }
  _handleTransparency(t) {
    this._prefersReducedTransparency = t.matches, this._hasChanged = true;
  }
  _handleContrastMore(t) {
    t.matches && (this._contrastPreference = "more"), this._hasChanged = true;
  }
  _handleContrastLess(t) {
    t.matches && (this._contrastPreference = "less"), this._hasChanged = true;
  }
  _handleContrastNone(t) {
    t.matches && (this._contrastPreference = "no-preference"), this._hasChanged = true;
  }
  _handleColorSchemeLight(t) {
    t.matches && (this._colorSchemePreference = "light"), this._hasChanged = true;
  }
  _handleColorSchemeDark(t) {
    t.matches && (this._colorSchemePreference = "dark"), this._hasChanged = true;
  }
  ...
  advance(t) {
    return this._hasChanged ? (this._hasChanged = false, true) : false;
  }
};
var Ot;
function ya() {
...
//# sourceMappingURL=counterpoint-vis.js.map
