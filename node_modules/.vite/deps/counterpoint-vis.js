...
var bi = ((i) => (i[i.DEFAULT = 0] = "DEFAULT", i[i.ALWAYS = 1] = "ALWAYS", i[i.WHEN_UPDATED = 2] = "WHEN_UPDATED", i))(bi || {});
var b = class _b {
  /**
   *
  ...
  copy(t = {}) {
    let e = { ...this, ...t };
    return t.value !== void 0 && (e.valueFn = void 0), t.valueFn !== void 0 && (e.value = void 0), new _b(e);
  }
  addListener(t) {
  ...
  _computeAnimation(t = true) {
    ...
    this._animationFinished() && t ? (this.valueFn ? this.compute() : this.value = s, this._cleanUpAnimation(false), this._animatedValue = null) : this._animatedValue = s;
  }
  _animationFinished() {
   ...
   */
  set(t) {
    typeof t == "function" ? (this.value != null && (this._computedValue = this.value), this.valueFn = t, this.value = void 0, this._animatedValue = null) : (this.value = t, this.valueFn = null, this._animatedValue = null), this.needsUpdate = true, this._lastTickValue = void 0, this.animation && this._cleanUpAnimation(true), this._listeners.forEach((e) => e(this, false));
  }
  /**
   ...
   */
  last() {
    return this.animation && this._computeAnimation(false), this._lastTickValue !== void 0 ? this._lastTickValue : this._animatedValue != null ? this._animatedValue : this.value !== void 0 ? this.value : this._computedValue;
  }
  /**
   ...
   */
  animate(t) {
    return this._timeProvider && (this.currentTime = this._timeProvider()), this.animation && (this._computeAnimation(), this.valueFn ? this._computedValue = this._animatedValue : this.value = this._animatedValue, this._lastTickValue = this._animatedValue, this._cleanUpAnimation(true)), this.animation = {
      animator: t,
      initial: this.last(),
...
function wt(i, {
  ...
  let o = i.coords;
  if (o = o.map((l) => l || 0), r && !tt(i) && (o = I(it(i), r === true ? void 0 : r).coords), e.type === "custom")
...
var mt = 2 ** -16;
var Ft = -0.35828683;
var gt = (Math.log2(65504) + 9.72) / 17.52;
var Wr = new S({
  id: "acescc",
  name: "ACEScc",
...
var Kr = ((i) => (i.Waiting = "waiting", i.Entering = "entering", i.Visible = "visible", i.Exiting = "exiting", i.Completed = "completed", i))(Kr || {});
var ta = ((i) => (i.Show = "show", i.Hide = "hide", i))(ta || {});
var ea = class {
  constructor(t = {}) {
    this.markStates = /* @__PURE__ */ new Map(), this.marksByID = /* @__PURE__ */ new Map(), this.queuedAnimations = /* @__PURE__ */ new Map(), this._flushTimer = null, this.animatingMarks = /* @__PURE__ */ new Set(), this._updated = false, this.defer = false, this.saveExitedMarks = false, this._callbacks = {
...
var Z = class _Z {
  ...
  advance(t = void 0) {
    ...
    return e ? (this.framesWithUpdate += 1, this.framesWithUpdate > ra && console.warn("Marks are being updated excessively!"), this._changedLastTick = true, true) : (this.framesWithUpdate = 0, this._changedLastTick = false, false);
  }
  /**
  ...
  setAttr(t, e = void 0) {
    ...
    let a = r.last();
    return e === void 0 ? r.compute() : r.set(e), _t(a, r.data()) || this._listeners.forEach((s) => s(this, t, false)), this;
  }
  /**
...
var ma = class {
  constructor(t = {}) {
    this.animationDuration = 1e3, this.squareAspect = true, this._xDomain = [
      ...
      new b(0),
      new b(1)
    ], this._xScaleFactor = new b(1), this._yScaleFactor = new b(1), this._translateX = new b(0), this._translateY = new b(0), this._calculatingTransform = false, this.timeProvider = Re(), this.controller = null, this._updatedNoAdvance = false, this.listeners = [], this.xScale = Object.assign(
...
var aa = ((i) => (i.none = "no-preference", i.more = "more", i.less = "less", i))(aa || {});
var sa = ((i) => (i.light = "light", i.dark = "dark", i))(sa || {});
var na = class {
  constructor() {
